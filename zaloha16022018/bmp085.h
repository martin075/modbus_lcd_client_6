...
#define BMP085_UNITPAOFFSET 0 //define a unit offset sea level(pa), Presov, Kosice correction
#define BMP085_UNITMOFFSET 0 //define a unit offset (m)KE 205m,PO 247m, according change of pressure - altitude is changing
